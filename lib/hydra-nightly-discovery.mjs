 ...
 *
 * Dispatches an agent (default: claude) to analyze the codebase and propose
 ...
 * @param {object} [opts]
 * @param {string} [opts.agent='claude'] - Agent to use for discovery
...
export async function runDiscovery(projectRoot, opts = {}) {
  ...
  const agent = opts.agent || discoveryCfg.agent || 'claude';
