...
const DEFAULT_CONFIG = {
  ...
  concierge: {
    enabled: true,
    model: _profileRoleDefaults.roles.concierge.model,
  ...
  evolve: {
    ...
    investigator: {
      enabled: true,
      agent: _profileRoleDefaults.roles.investigator.agent,
      model: _profileRoleDefaults.roles.investigator.model,
  ...
  nightly: {
    ...
    budget: {
      ...
      handoffAgent: 'codex',
      handoffModel: _profileRoleDefaults.roles.nightlyHandoff.model,
    },
    tasks: [],
    investigator: { enabled: true },
  },
...
export function mergeWithDefaults(config) {
  ...
  return {
    ...
    recommendations: deepMergeSection(DEFAULT_CONFIG.recommendations, parsed.recommendations),
