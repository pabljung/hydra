...
async function main() {
  ...
  const configuredWeeklyBudgets = Object.values(cfg.usage?.weeklyTokenBudget || {})
    .filter((value) => Number.isFinite(value) && value > 0);
  const weeklyBudget = Math.max(...configuredWeeklyBudgets, (cfg.usage?.sessionBudget || 5_000_000) * 5);
