...
server.registerTool(
  'hydra_ask',
  {
    ...
    description: [
      ...
      'Use claude for: architecture, analysis, review, critique, and research.',
      'Use gemini for: analysis and review when Gemini is installed.',
      'Use codex for: implementation, refactoring, code generation, writing tests.',
      '',
      'Args:',
      '  - agent: "claude" (architect/analyst), "gemini" (optional reviewer), or "codex" (implementer)',
    ...
    inputSchema: {
      agent: z.enum(['claude', 'gemini', 'codex']).describe('Which installed agent to ask; unavailable agents use configured fallbacks'),
